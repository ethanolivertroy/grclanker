...
| 5 | Collaboration allowlist audit | sharing_collaboration | BOX-05 | fail on public email domains; warn on entries older than `stale_allowlist_days`, exempt users, or a truncated allowlist; pass otherwise |

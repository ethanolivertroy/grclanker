...
<host>-<accountId>-audit-bundle/
  ...
  core_data/                       raw API snapshots, secrets masked; paginated collections carry truncated, seen, total, items

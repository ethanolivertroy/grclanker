...
| `GET compute/v1/projects/{p}/aggregated/sslPolicies` | [sslPolicies.aggregatedList](https://cloud.google.com/compute/docs/reference/rest/v1/sslPolicies/aggregatedList), [SSL policy concepts](https://cloud.google.com/load-balancing/docs/ssl-policies-concepts) | `unreachables[]`, `items{}.warning.code`; `items{}.sslPolicies[].name`, `selfLink`, `region`, `minTlsVersion`, `profile` |

...
<account>-knowbe4-audit-bundle/
  ...
  core_data/collection_status.json
                      one row per inventory: readable, error, truncated, seen, total, limit, limit_argument

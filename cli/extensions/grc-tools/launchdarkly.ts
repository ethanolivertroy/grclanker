...
export function registerLaunchdarklyTools(pi: any): void {
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...authParams,
      member_limit: Type.Optional(Type.Number({ description: "Maximum members to inspect. Defaults to 1000.", default: 1000 })),
      team_limit: Type.Optional(Type.Number({ description: "Maximum teams to inspect for custom role assignments. Defaults to 100.", default: 100 })),
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...authParams,
      role_limit: Type.Optional(Type.Number({ description: "Maximum custom roles to inspect. Defaults to 200.", default: 200 })),
      token_limit: Type.Optional(Type.Number({ description: "Maximum access tokens to inspect. Defaults to 500.", default: 500 })),
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...authParams,
      project_limit: Type.Optional(Type.Number({ description: "Maximum projects to inspect. Defaults to 50.", default: 50 })),
      environment_limit: Type.Optional(Type.Number({ description: "Maximum environments per project to inspect. Defaults to 50.", default: 50 })),
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...authParams,
      project_limit: Type.Optional(Type.Number({ description: "Maximum projects to inspect. Defaults to 50.", default: 50 })),
      flag_limit: Type.Optional(Type.Number({ description: "Maximum flags per environment to inspect. Defaults to 500.", default: 500 })),
      project_keys: projectKeysParam,
      production_pattern: productionPatternParam,
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...
      member_limit: Type.Optional(Type.Number({ description: "Maximum members to inspect. Defaults to 1000.", default: 1000 })),
      team_limit: Type.Optional(Type.Number({ description: "Maximum teams to inspect. Defaults to 100.", default: 100 })),
      max_owners: Type.Optional(Type.Number({ description: "Maximum acceptable Owner base role members. Defaults to 1.", default: 1 })),
      max_admins: Type.Optional(Type.Number({ description: "Maximum acceptable Admin base role members before warning. Defaults to 5.", default: 5 })),
